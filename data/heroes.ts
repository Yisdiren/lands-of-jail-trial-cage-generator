...
// Cage data is intentionally conservative: unknown season numbers are stored as 0
// rather than guessed. KOF heroes are excluded because the event ended and they
// are not part of the alliance's current Cage plan.
export const heroes: Hero[] = [
  // Shieldbearers
  { name: 'Tyronn', cls: 'Shield', season: 0, rarity: 'SSR', leftSkill: '+25% damage class', leftValue: 25, leftTier: 'top', cageAllowed: true },
  { name: 'Phoenix', cls: 'Shield', season: 0, rarity: 'SSR', leftSkill: '+25% damage class', leftValue: 25, leftTier: 'top', cageAllowed: true },
  ...
  // Bombers
  { name: 'Lunarl', cls: 'Bomber', season: 0, rarity: 'SR', leftSkill: '+25% damage class', leftValue: 25, leftTier: 'top', cageAllowed: true },
  { name: 'Koschevoi', cls: 'Bomber', season: 0, rarity: 'SSR', leftSkill: '+25% all troop DMG', leftValue: 25, leftTier: 'top', cageAllowed: true },
  { name: 'Ryuichi', cls: 'Bomber', season: 0, rarity: 'SSR', leftSkill: '+25% ATK/Crit class', leftValue: 25, leftTier: 'strong', cageAllowed: true },
  { name: 'Vivian', cls: 'Bomber', season: 0, rarity: 'SSR', leftSkill: '+25% ATK class', leftValue: 25, leftTier: 'strong', cageAllowed: true },
  { name: 'Samir', cls: 'Bomber', season: 0, rarity: 'SR', leftSkill: 'Filler/Decent LEFT skill', leftValue: 10, leftTier: 'filler', cageAllowed: true },
  { name: 'Flameborne', cls: 'Bomber', season: 0, rarity: 'SR', leftSkill: 'Filler/Decent LEFT skill', leftValue: 10, leftTier: 'filler', cageAllowed: true, notes: 'Strong empirical Gorilla performer; Cage LEFT only as filler.' },
  { name: 'Whisper', cls: 'Bomber', season: 0, rarity: 'SSR', leftSkill: 'Filler/Decent LEFT skill', leftValue: 10, leftTier: 'filler', cageAllowed: true },
  { name: 'Lee', cls: 'Bomber', season: 0, rarity: 'SSR', leftSkill: 'Filler/Decent LEFT skill', leftValue: 10, leftTier: 'filler', cageAllowed: true },
  ...
  { name: 'Worrell', cls: 'Bomber', season: 6, rarity: 'SSR', leftSkill: '+25% Basic Attack DMG (all allied troops)', leftValue: 25, leftTier: 'top', cageAllowed: true, notes: 'S6 priority target.' },
  ...
  // Shooters
  { name: 'Veronica', cls: 'Shooter', season: 0, rarity: 'SSR', leftSkill: '+25% damage class (proc/reliability caveat)', leftValue: 25, leftTier: 'top', cageAllowed: true },
  { name: 'Lofili', cls: 'Shooter', season: 0, rarity: 'SR', leftSkill: '+25% ATK class', leftValue: 25, leftTier: 'strong', cageAllowed: true },
  ...
  { name: 'Devilian', cls: 'Shooter', season: 0, rarity: 'SSR', leftSkill: 'Filler/Decent LEFT skill', leftValue: 10, leftTier: 'filler', cageAllowed: true },
  ...
  { name: 'Kate', cls: 'Shooter', season: 6, rarity: 'SSR', leftSkill: '+25% ATK (all allied troops)', leftValue: 25, leftTier: 'strong', cageAllowed: true, notes: 'S6. Also has a periodic all-troop DMG boost.' },
];
