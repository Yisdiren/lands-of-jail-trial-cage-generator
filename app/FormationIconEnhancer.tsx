...
function enhanceGenerator(){generalizeStaticCopy();document.querySelectorAll<HTMLElement>(".formation-card .slot").forEach(addHeroIcon);document.querySelectorAll<HTMLElement>(".formation-card").forEach(addFormationReason);document.querySelectorAll<HTMLElement>(".result > .slots > .slot").forEach(addHeroIcon);addMemberOverview();addBatchGenerator();addCurrentFormationCopy();addSetupWizard()}
